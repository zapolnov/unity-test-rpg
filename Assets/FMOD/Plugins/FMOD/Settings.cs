            ...
            get
            {
                if (instance == null)
                {
                    ...
                    if (instance == null)
                    {
                        ...
                        #if UNITY_EDITOR
                        if (!System.IO.Directory.Exists("Assets/FMOD/Resources"))
                        {
                            AssetDatabase.CreateFolder("Assets/FMOD", "Resources");
                        }
                        AssetDatabase.CreateAsset(instance, "Assets/FMOD/Resources/" + SettingsAssetName + ".asset");
                        #endif
                    }
                }
                return instance;
